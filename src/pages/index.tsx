  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen bg-gray-700 ">
        ...
        {!showResult ? (
          <div className="flex flex-col h-full md:max-h-3/4 justify-start items-center">
            {/* display the current question text */}
            <div className="text-orange-100 text-3xl text-center py-5">
            ...
            <div className="flex flex-col h-full justify-around">
              {currentQuestion?.options.map((option) => (
                ...
                <button
                  className="btn glass text-orange-100 my-5"
                  key={option.answer}
          ...
          <div className="flex flex-col h-full justify-around items-center text-orange-100">
            ...
            <div className="flex flex-row justify-around w-full max-w-4xl my-10">
              ...
              <label className="btn glass text-orange-100">
